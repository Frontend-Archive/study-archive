...
export default async function Home() {
  ...
  return <main>
    <SiteHeader />
    <section className="hero" id="top"><p className="eyebrow">Frontend study · Since 2026</p><h1>배운 것을 남기고,<br /><em>시간으로 엮습니다.</em></h1><p className="hero-copy">네 명의 프론트엔드 개발자가 매달 탐구한 주제와 관점을 기록합니다. 한 번의 발표가 오래 읽히는 지식이 되도록.</p><div className="hero-actions" aria-label="빠른 탐색"><a href="#archive">최신 기록 보기 <span aria-hidden="true">↓</span></a><a href="/feed.xml">RSS 구독 <span aria-hidden="true">↗</span></a></div><div className="stats" aria-label="아카이브 현황"><div><strong>{String(sessions.length).padStart(2, "0")}</strong><span>Sessions</span></div><div><strong>{String(published.length).padStart(2, "0")}</strong><span>Articles</span></div><div><strong>{String(MEMBERS.length).padStart(2, "0")}</strong><span>Members</span></div></div></section>
